  ...
  <div class="navbar-content">
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="{{route('tourist_police_chat.index')}}" id="messageDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          ...
          <ul class="list-unstyled p-1">
            <li class="dropdown-item py-2">
              <a href="{{route('profile_tp.edit')}}" class="text-body ms-0">
                <i class="me-2 icon-md" data-feather="user"></i>
                <span>Profile</span>
              </a>
            </li>
            <li class="dropdown-item py-2">
              <a href="{{route('profile_tp.change_account_information')}}" class="text-body ms-0">
