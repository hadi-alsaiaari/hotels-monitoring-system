        ...
        <div class="card">
          <div class="card-body">
            <h6 class="card-title">Add Employee</h6>
              <form action="{{route("{$x}_store_employees")}}" method="POST" enctype="multipart/form-data">
                @csrf 
                <div class="row">
                  <div class="col-sm-3">
                    <div class="mb-3">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      ...
                      <select name="role_id" id="job" class="form-control" aria-invalid="false" >
                        <option selected="" disabled="" required>Select Job</option>
                ...
                <a href="" class="btn btn-danger me-1 link-icon" >
                  Cancel 
                </a>
              </form>
          </div>
