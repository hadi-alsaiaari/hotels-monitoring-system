...
<div class="page-content">
    <div class="col-md-14 stretch-card" >
        <div class="card">
          <div class="card-body">
            <h6 class="card-title">Add Executive Manager</h6>
            <p class="mb-2"><span style="color: red">*Obligatoire</span></p>
              <form action="{{route('store_EM')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                <div class="row">
                  <div class="col-sm-3">
                    <div class="mb-3">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select name="education_level" class="js-example-basic-single form-select" data-width="50%">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <label class="form-label">Work License Number <span style="color: red">*</span></label>
                      <input type="text" name="work_license_number" class="form-control" placeholder="Enter Work License Number" required>
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('work_license_number')" />
                  </div><!-- Col -->
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <label class="form-label">Date of Work License <span style="color: red">*</span></label>
                      <input type="date" name="date_of_work_license" class="form-control" placeholder="Enter Date of Work License" required>
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('date_of_work_license')" />
                  </div><!-- Col -->
                  <hr>
                  <div class="col-sm-4">
                    <div class="mb-3">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <label class="form-label">Experience Certificate <span style="color: red">*</span></label>
                      <input type="file" name="experience_certificate" class="form-control" accept="application/pdf">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('experience_certificate')" />
                  </div><!-- Col -->
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <label class="form-label">Identity Photo <span style="color: red">*</span></label>
                      <input type="file" name="identity_photo" class="form-control" accept="application/pdf">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('identity_photo')" />
                  </div><!-- Col -->
                </div><!-- Row -->
                <button type="submit" class="btn btn-primary submit">Create</button>
                <a href="{{route('index_EM',$id)}}" class="btn btn-danger me-1 link-icon" >
                  Cancel 
                </a>
              </form>
          </div>
