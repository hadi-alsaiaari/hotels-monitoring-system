						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Today's Accommodations</h4>
										...
										<tbody>
											@foreach($accommodations as $n => $accommodation)
												...
												<tr>
													...
													<td>
														{{-- <form action="{{route("{$x}_accommodations.show")}}" method="post">
															@csrf
															<input type="text" name="id" value="{{$accommodation->accommodation_details_count}}" hidden>
