...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>HMS - Security Department Office Panel</title>
...
<!-- Spinner End -->
	<div class="main-wrapper">
		...
		@include('security_department_office.layouts.sidebar')
		<!-- partial -->
	
		<div class="page-wrapper">
					
			<!-- partial:partials/_navbar.html -->
			@include('security_department_office.layouts.header')
			<!-- partial -->

			@yield('dashboard')

			<!-- partial:partials/_footer.html -->
			@include('security_department_office.layouts.footer')
			<!-- partial -->
