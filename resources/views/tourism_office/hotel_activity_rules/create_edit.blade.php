    ...
    <div class="row profile-body">
      ...
      <div class="col-md-8 col-xl-12 middle-wrapper">
        <div class="row">
            <div class="card">
            <div class="card-body">
              @if ( (!empty($rule->body)) ? false : true )
              <h6 class="card-title">Add rule</h6>

              <form class="forms-sample" method="POST" action="{{route('add.activity_rules')}}" enctype="multipart/form-data">
                  @csrf 
                  <label for="exampleInputUsername1" class="form-label">Description rule</label>
                  <div class="col-lg-8">
                    <textarea id="maxlength-textarea" name="body" class="form-control" maxlength="1000" rows="8" placeholder="This textarea has a limit of 100 chars."></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">PDF <span style="color: red">*</span></label>
                  <input class="form-control" type="file" name="image"  style="width: 60%;" id="image" accept="application/pdf">
                  </div>
